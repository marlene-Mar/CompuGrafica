...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados Marlene", nullptr, nullptr);
	...
	//models piezas del modelo por separado
	//En 3d max se exporta cada parte al origen (0,0,0), pero dentro de vs colocarles los valores de la posición 
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//las rotaciones permiten controlar las animaciones de cada parte
		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
